...
public class BookFlight extends JFrame implements ActionListener {
    ...
    public BookFlight() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("management/system/icons/details.jpg"));
        ...
        if(ae.getSource() == fetchButton) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Please enter correct addhar number");
                }
